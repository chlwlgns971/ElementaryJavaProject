...
public class SetMemInfo {
	...
	SetMemInfo(){
		...
		setAddr();
		setPN();
		SignUpDTO signDto=new SignUpDTO(this.userID,this.passWord,this.name,this.regNo1,this.addr,this.userPN); 
		login.insert(signDto);
	}
	public void setID() {
		while(true) {
			System.out.println("==================================================");
