...
public class ManageMenu {
	...
	public void ShowManagerSelect() {
		while (true) {
			...
			System.out.println("1.회원 조회 2.지점 조회 3.차량 조회 4.모델 조회 5.예약 조회 6.프로그램 종료");
			System.out.println("===================================================================");
			str = sc.nextLine();
	...
	public void ManagerMemberShowInfo() {
		while (true) {
			...
			System.out.println("1. 회원 전체 조회  2. 회원 선택 조회  3. 프로그램 종료");
			System.out.println("====================================================");
			str = sc.nextLine();
			str = str.replaceAll("\\s", "");
			try {
	...
	public void ManagerBranchShowInfo() {
		while (true) {
			...
			System.out.println("1. 지점 전체 조회  2. 지점 선택 조회  3. 프로그램 종료");
			System.out.println("====================================================");
			str = sc.nextLine();
			str = str.replaceAll("\\s", "");
			try {
	...
	public void ManagerCarShowInfo() {
		while (true) {
			...
			System.out.println("1. 전체 차량 조회  2. 프로그램종료  ");
			System.out.println("==============================");
			str = sc.nextLine();
			str = str.replaceAll("\\s", "");
			try {
	...
	public void ManagerModelShowInfo() {
		while (true) {
			...
			System.out.println("1. 모델 전체 조회  2. 모델 선택 조회  3. 프로그램 종료");
			System.out.println("====================================================");
			str = sc.nextLine();
			str = str.replaceAll("\\s", "");
			try {
	...
	public void ManagerRSVShowInfo() {
		while (true) {
			...
			System.out.println("1. 예약 전체 조회  2. 예약 선택 조회  3. 프로그램 종료");
			System.out.println("====================================================");
			str = sc.nextLine();
			str = str.replaceAll("\\s", "");
			try {
